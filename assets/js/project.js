...
function displayProjects() {
    ...
    // Add h1 element outside the loop
    const h1Element = document.createElement("h1");
    h1Element.style.textAlign = "center";
    h1Element.textContent = "My Projects";
    outputContent.appendChild(h1Element);
    ...
    projects.forEach((project, index) => { //edit
        // Menghitung waktu
        ...
        const technologyIcons = Array.from(checkboxes).map(tech => {
            switch (tech.value) {
                case 'Node.Js':
        ...
        card.innerHTML = `
            <div class="card h-100 shadow">
                <div card>
                    <img src="${project.imageLink}" alt="Project Image" class="card-img-top">
                </div>
                <div class="card-body">
...
function Submit(e) {
    ...
    const newProject = {
        ...
        endDate,
        description,
        technologyIcons, // Correct variable name
        imageLink
    };
